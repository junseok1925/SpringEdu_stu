 ...
 <jsp:include page="../common/header.jsp"/>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
       <form method="post" enctype="multipart/form-data" action="${contextPath}/memImageUpdate.do">
       <input type="hidden" name="memID" value="${mvo.memID}"/>
          <table class="table table-bordered" style="text-align: center; border: 1px solic #dddddd;">
             ...
             <td colspan="2" style="text-align: left;">
                <input type="submit" class="btn btn-primary btn-sm pull-right" style="right" value="등록"/>
             </td>
             </tr>
          </table>
       </form>
